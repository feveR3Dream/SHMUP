...
public class PlayerKeyboardMovement : MonoBehaviour
{
    ...
    void Movement()
    {
        ...
        viewportPos.x = Mathf.Clamp01(viewportPos.x); // Clamping the player within the X Axis  // The reason I use "Mathf.Clamp01" is because it return value between 0 and 1, and ultimately,
